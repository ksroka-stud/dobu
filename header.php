...
<head>
    ...
    <style>
        body { background-color: #000000; color: rgb(255, 255, 255); font-family: Arial, sans-serif; }form { margin: 20px 0; padding: 20px; border: 1px solid #ccc; border-radius: 8px; }
